...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 27.56s.
...
- **What's verified:** 491/491 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 88 Next:** HMC (Hybrid Memory Cube Consortium 2.1) 3D-Stacked DRAM Serial Interface & Packet Routing Engine.
