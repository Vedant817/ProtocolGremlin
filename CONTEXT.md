...
- **What's verified:** 317/317 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 59 Next:** USB 3.0 SuperSpeed (5.0 Gbps) Physical Layer & 8b/10b Link Training Engine (differential transmitter/receiver equalization, 8b/10b symbol encoding/decoding, running disparity tracking, Ordered Sets SKP/COM/PAD/SHP, Link Training and Status State Machine LTSSM polling/compliance, and IHP 130nm SG13G2 PPA scaling).
