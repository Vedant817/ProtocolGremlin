...
- **What's verified:** 257/257 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
docs/           architecture, ISA, verification, toolchain, PPA, limitations, multilane_study, ethernet_study, watchdog_study, power_study, crypto_study, scheduler_study, canfd_study, floorplan_study, interrupt_study, mpu_study, crc_study, i3c_study, qei_study, lin_study, biss_study, mil1553_study, wiegand_study, arinc429_study, midi2_study, i2s_study, spacewire_study, sent_study, ethercat_study
...
bash scripts/regress.sh     # runs all 257 cocotb regression tests (~75s)
...
python3 scripts/mutate.py   # runs RTL mutation testing campaign (51/51 killed)
...
**Iteration 49 Next:** Profibus DP (Process Field Bus Decentralized Peripherals - IEC 61158 / EN 50170) RS-485 Fieldbus Protocol Engine (SD1/SD2/SD3/SD4 telegram framing, start/end delimiters [0x68, 0x16], Hamming distance HD=4 security, 8-bit FCS checksum, slave address filtering, token-ring master/slave protocol acceleration, and IHP 130nm SG13G2 PPA scaling).
