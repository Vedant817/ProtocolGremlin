...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 39.39s.
...
- **What's verified:** 467/467 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 84 Next:** LPDDR4 / LPDDR4X (JEDEC JESD209-4) Low-Power High-Speed Memory Physical Layer & Command Engine.
