...
**Iteration 57 Next:** Ethernet 100BASE-TX (IEEE 802.3u Fast Ethernet) 4B5B Block Coding, Stream Cipher Scrambler, and MLT-3 Physical Sublayer Engine (4B5B nibble encoding/decoding, 11-bit LFSR pseudo-random stream cipher scrambler/descrambler $x^{11} + x^9 + 1$, three-level Multi-Level Transmit MLT-3 signaling +1/0/-1, Carrier Sense / Collision Detect, and IHP 130nm SG13G2 PPA scaling).
