...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 24.00s.
...
- **What's verified:** 485/485 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 87 Next:** UFS 3.1 / 4.0 (Universal Flash Storage / JEDEC JESD220) Mobile Storage Protocol Engine.
