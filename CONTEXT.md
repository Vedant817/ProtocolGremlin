...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 25.55s.
...
- **What's verified:** 413/413 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 75 Next:** NVLink (NVIDIA High-Speed GPU Interconnect) Physical & Data Link Layer Engine.
