...
**Iteration 64 Next:** MIPI C-PHY v2.0 Physical Layer Engine (3-Phase symbol encoding, 16b/7t trio transmission, 5.7 Gbps per trio, wire state transitions, and IHP 130nm SG13G2 PPA scaling).
