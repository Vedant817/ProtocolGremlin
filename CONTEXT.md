...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 31.15s.
...
- **What's verified:** 461/461 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 83 Next:** GDDR6 / GDDR6X (JEDEC JESD250) High-Speed Graphics Memory Physical Layer & Command Engine.
