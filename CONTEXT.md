...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 25.07s.
...
- **What's verified:** 479/479 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 86 Next:** eMMC 5.1 / SD 6.0 UHS-II (JEDEC JESD84-B51 / SD Association) Non-Volatile Memory Bus & Card Protocol Engine.
