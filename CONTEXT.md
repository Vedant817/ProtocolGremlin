...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 27.00s.
...
- **What's verified:** 497/497 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 89 Next:** QDR-IV / QDR-II+ (Quad Data Rate SRAM / QDR Consortium) Synchronous Memory Engine.
