...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 24.63s.
...
- **What's verified:** 407/407 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 74 Next:** Bunch of Wires (BoW - OCP ODSA) & OpenHBI Die-to-Die Physical Layer Engine.
