...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 27.40s.
...
- **What's verified:** 473/473 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 85 Next:** DDR4 / DDR3 (JEDEC JESD79-4 / JESD79-3) Synchronous Dynamic RAM Physical Layer & Command Controller Engine.
