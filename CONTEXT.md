...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 26.11s.
...
- **What's verified:** 503/503 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 90 Next:** RLDRAM 3 / Reduced Latency DRAM 3 (Micron Technology) Ultra-Low Latency Synchronous DRAM Protocol Engine.
