...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 26.92s.
...
- **What's verified:** 383/383 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 70 Next:** Coherent Accelerator Processor Interface (OpenCAPI / CXL) Physical Layer.
