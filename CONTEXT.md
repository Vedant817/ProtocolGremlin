...
- **What exists:**
  ...
  8. **Gate-Level Timing Verification:** Full post-synthesis physical netlist simulation
     ...
     verifying 8/8 physical protocol tests across external chip pins in 31.54s.
...
- **What's verified:** 395/395 RTL tests pass via `scripts/regress.sh` and 8/8 gate-level timing tests pass via `scripts/test_gl.sh`:
...
**Iteration 72 Next:** InfiniBand XDR/GDR & Ultra Ethernet Consortium (UEC) Transport Engine.
